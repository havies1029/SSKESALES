...
class TitleCrudFormPageFormState extends State<TitleCrudFormPage> {
                      ...
                      children: [
                        ...
                        TextFormField(
                          onChanged: (value) {
                            if (value.isNotEmpty) {
                              removeError(
                                  error: "Field 'Title' tidak boleh kosong.");
                            }
                          },
                          validator: (value) {
                            if (value == null || value.isEmpty) {
                              addError(error: "Field 'Title' tidak boleh kosong.");
                              return "";
                            }
                            return null;
                          },
  ...
  void loadData() {
    if (widget.viewMode == "ubah") {
      titleCrudBloc.add(TitleCrudLihatEvent(recordId: widget.recordId));
    }
  }
