...
class RealGroupCariTileWidget extends StatelessWidget {
	final String orgName;
	final String personId;
	final String personName;

	const RealGroupCariTileWidget(
		{super.key,
                ...
                onTap: () {
                  Navigator.push(
                    ...
                    MaterialPageRoute(builder: (context) {
                      return RealGroupCariRoutePage(personId: personId, personName: personName);
                    }),
                  );
                },
                child: const Icon(
