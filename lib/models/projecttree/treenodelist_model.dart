...
class TreenodeListModel {
	...
	TreenodeListModel({required this.prjnodetypeId, required this.prjtree1Id, 
		required this.prjtree2Id, required this.prjtree2ParentId, 
		required this.remarks1, required this.remarks2});

	factory TreenodeListModel.fromJson(Map<String, dynamic> data) {
		return TreenodeListModel(
