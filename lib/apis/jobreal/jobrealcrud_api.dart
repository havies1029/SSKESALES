...
class JobRealCrudAPI {
  ...
  Future<bool> jobRealCrudHapusAPI(String jobreal1Id) async {
    String hapusEndpoint =
        "${AppData.prefixEndPoint}/api/jobreal/jobrealcrud/delete";
  ...
  Future<JobRealCrudModel> jobRealCrudLihatAPI(String jobreal1Id) async {
    ...
    String lihatEndpoint =
        "${AppData.prefixEndPoint}/api/jobreal/jobrealcrud/read";
  ...
  Future<ReturnDataAPI> jobRealOtorisasiAPI(String jobreal1Id) async {
    String hapusEndpoint =
        "${AppData.prefixEndPoint}/api/jobreal/jobrealcrud/otorisasi";
    Map<String, String> queryParams = {
      'jobreal1Id': jobreal1Id,
      'modul_id': 'jobRealCrudHapusAPI'
    };
