...
class UserLoginApi {
  ...
  Future<User> validateUserLogin(UserLogin userLogin) async {
    ...
    Future<bool> isTokenAktif(String userId, String tokenId) async {
      String urlIsTokenAktifEndPoint = "${AppData.prefixEndPoint}/api/login/istokenaktif";
      ...
      var uri = AppData.uriHtpp(AppData.httpAuthority, urlIsTokenAktifEndPoint, queryParams);
