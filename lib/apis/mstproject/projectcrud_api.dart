...
class ProjectCrudAPI {
  ...
  Future<bool> projectCrudHapusAPI(String mprojectId) async {
    String hapusEndpoint =
        "${AppData.prefixEndPoint}/api/mstproject/projectcrud/delete";
  ...
  Future<ProjectCrudModel> projectCrudLihatAPI(String mprojectId) async {
    debugPrint("projectCrudLihatAPI");
    String lihatEndpoint =
        "${AppData.prefixEndPoint}/api/mstproject/projectcrud/read";
    ...
    if (response.statusCode == 200) {
      debugPrint(
          "projectCrudLihatAPI -> response.body : ${jsonDecode(response.body)}");
